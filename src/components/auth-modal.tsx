        ...
        >
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 text-gray-800 dark:text-white font-medium text-sm transition-colors disabled:opacity-50"
            >
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <span className="absolute px-3 bg-white dark:bg-[#121214] text-xs text-gray-400">
              Or with email
            </span>
          </div>
